#!/bin/bash
# Benchmark: Clustered vs non-clustered vs no-index on MariaDB (range)
...
output_csv="$SCRIPT_DIR/../../results/mariadb_clustered_nonclustered_noindex_range.csv"  # change if needed
...
echo "MariaDB clustered/non-clustered/noindex (range) benchmark finished. Results saved to: $output_csv"
