#!/bin/bash
# Benchmark: Clustered vs non-clustered vs no-index on MySQL (range)
...
output_csv="$SCRIPT_DIR/../../results/mysql_clustered_nonclustered_noindex_range.csv"  # change if needed
...
echo "MySQL clustered/non-clustered/noindex (range) benchmark finished. Results saved to: $output_csv"
