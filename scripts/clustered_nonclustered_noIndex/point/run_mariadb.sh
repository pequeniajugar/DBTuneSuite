#!/bin/bash
# Benchmark: Clustered vs non-clustered vs no-index on MariaDB (point)
...
output_csv="$SCRIPT_DIR/../../results/mariadb_clustered_nonclustered_noindex_point.csv"  # change if needed
...
echo "MariaDB clustered/non-clustered/noindex (point) benchmark finished. Results saved to: $output_csv"
