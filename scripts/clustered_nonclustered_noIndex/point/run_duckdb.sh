#!/bin/bash
# Benchmark: Clustered vs non-clustered vs no-index on DuckDB (point)
...
output_csv="$SCRIPT_DIR/../../results/duckdb_clustered_nonclustered_noindex_point.csv"  # change if needed
...
echo "DuckDB clustered/non-clustered/noindex (point) benchmark finished. Results saved to: $output_csv"
