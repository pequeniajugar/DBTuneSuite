#!/bin/bash
# Benchmark: Hash vs B+Tree vs No Index on MySQL (Point Query on ssnum)
...
#change file name to mysql_small_hash_vs_btree_point.csv
output_csv="$SCRIPT_DIR/../results/mysql_big_hash_vs_btree_point.csv"
