#!/bin/bash
# Benchmark: Hash vs B+Tree vs No Index on MariaDB
...
#change file name to mariadb_small_hash_vs_btree_multipoint.csv
output_csv="$SCRIPT_DIR/../results/mariadb_big_hash_vs_btree_multipoint.csv"
