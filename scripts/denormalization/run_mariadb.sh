#!/bin/bash
# Benchmark: Denormalization on MariaDB (big TPCH) using base_mariadb.sh
...
output_csv="$SCRIPT_DIR/../results/mariadb_big_denormalization.csv"  # change if needed
...
# bash "$SCRIPT_DIR/../configure_mariadb.sh" \
#   "$database_name" \
#   "DROP TABLE IF EXISTS lineitemdenormalized;"
