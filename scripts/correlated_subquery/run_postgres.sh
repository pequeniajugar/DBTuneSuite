#!/bin/bash
# Benchmark: Correlated Subquery vs alternatives on PostgreSQL (small)
...
output_csv="$SCRIPT_DIR/../results/postgres_small_correlated_subquery.csv"  # change if needed
