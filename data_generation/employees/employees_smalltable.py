...
def generate_employees(num_employees, batch_size=1000, file_name="employeesindex.csv"):
    """
    ...
    file_name = f"employeesindex_small.csv"

    unique_count = num_employees  # Number of unique values
    ...
    global_hundreds1 = np.repeat(unique_hundreds1, 1)  # Sorted
