...
def generate_and_save_techdept(num_employees, batch_size, file_name="techdept.csv"):
    num_dept = num_employees//100  # Number of departments
...
def generate_and_save_employees(num_employees, batch_size, file_name="employees.csv"):
    depts = generate_uniform_dpts(num_employees)  
...
dept_names = generate_and_save_techdept(num_employees, batch_size,f"techdept_uniform_10_{exponent}.csv")
generate_and_save_employees(num_employees, batch_size, f"employees_uniform_10_{exponent}.csv")
generate_and_save_students(num_employees, batch_size, f"students_uniform_10_{exponent}.csv")
