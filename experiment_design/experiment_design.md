...
```sql
select * from employees where ssnum BETWEEN 100 AND 1100; 
```

nonclustered index

```sql
select * from employees where ssnumpermuted1 BETWEEN 100 AND 1100; 
```

no index

```sql
select * from employees where ssnumpermuted2 BETWEEN 100 AND 1100; 
```
